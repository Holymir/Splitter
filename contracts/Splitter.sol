...
contract Splitter {
	...
	event WhenDeposit(address _from, address _toAddr1, address _toAddr2, uint _value); 
	event WhenWithDraw(address _from, uint _value);
	event WhenKilled(address _addr);
	...
	function split(address _addr1, address _addr2) public payable 
        ...
        WhenDeposit(msg.sender, _addr1, _addr2, amount);	
	}
	...
	function withDraw() public {
		...
		WhenWithDraw(msg.sender, amountToWithDraw);	
	}
